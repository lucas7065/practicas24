...
export class VistaFiltroPersonalizadoComponent {
  ...
  generos: Array<string> = ['None','MMORPG', 'Shooter', 'Strategy', 'MOBA', 'Racing', 'Sports', 'Social', 'Sandbox', 'Open-world',
  ...
  sorts: Array<string> = ['None', 'Alphabetical','Release-date', 'Relevance', 'Popularity'];
